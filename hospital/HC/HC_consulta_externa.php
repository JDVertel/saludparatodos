...
<head>
    ...
    <title>Historia Clinica C Externa</title>
                ...
                <div class="row justify-content-center">
                    <div class="col-12  col-sm-12  col-md-12  col-lg-12 ">
                        ...
                        <div class="accordion" id="accordion_HC">
                            ...
                            <?php
                            include 'Cex_dacompanante.php';
                            include 'Cex_mconsulta.php';
                            include 'Cex_rsistemas.php';
                            include 'Cex_antecedentes.php';
                            include 'Cex_ant_ginecoobstetricos.php';
                            include 'Cex_ant_andrologicos.php';
                            include 'Cex_svitales.php';
                            include 'Cex_examenf.php';
                            include 'Cex_diagnostico.php';
                            include 'Cex_aconsulta.php';
                            include 'Cex_procedimientos.php';
                            include 'Cex_examenesl.php';
                            include 'Cex_medicamentos.php';
                            include 'Cex_imagenologia.php';
                            include 'Cex_remisiones.php';
                            include 'Cex_recomendaciones.php';
                            include 'Cex_incapacidades.php';
                            include 'Cex_cierrehc.php';
