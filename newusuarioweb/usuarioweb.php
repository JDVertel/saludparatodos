                ...
                <div class="accordion" id="accordionExample1">
                    <div class="card m-b-0">
                        <div class="card-header bg-white p-0" id="heading1">
                            <h5 class="mb-0">
                                <button class="btn btn-block btn-lg btn-info " type="button  " data-toggle="collapse" data-target="#collapse1" aria-expanded="true" aria-controls="collapse1" id="inicio">
                                    <div class="col-12">
                        ...
                        <div id="collapse1" class="collapse" aria-labelledby="heading1" data-parent="#accordionExample1">
                            <div class="card-body">
                                <div class="col-lg-12">
                                    <h5 style="text-align:center;">Beneficiarios de esta cuenta (4)</h5>
                    ...
                    <div class="card m-b-0">
                        <div class="card-header bg-white p-0" id="heading2">
                            <h5 class="mb-0">
                                <button class="btn btn-block btn-lg btn-info collapsed" type="button" data-toggle="collapse" data-target="#collapse2" aria-expanded="false" aria-controls="collapse2" id="inicio">
                                    <i class="icon-calender"></i> Citas
                                </button>
                            </h5>
                        </div>
                        <br>
                        <div id="collapse2" class="collapse" aria-labelledby="heading2" data-parent="#accordionExample1">
                            <div class="card-body">
                                <div class="col-lg-12 ">
                                    ...
                                    <div class="accordion" id="accordionExample2" style="padding: 0px;">
                                        <div class="card m-b-0">
                                            <div class="card-header bg-white p-0" id="headingA">
                                                <h5 class="mb-0">

                                                    <button class="btn btn-block   btn-outline-success collapsed" type="button" data-toggle="collapse" data-target="#collapseA" aria-expanded="false" aria-controls="collapse1">
                                                        <strong style="font-size: 20px;"> <i class="ti-bookmark-alt"></i> Listado de citas agendadas</strong><br>
                                            ...
                                            <div id="collapseA" class="collapse" aria-labelledby="heading1" data-parent="#accordionExample2">
                                                <div class="card-body">
                                                    <!--  -->
                                        ...
                                        <div class="card m-b-0">
                                            <div class="card-header bg-white p-0" id="heading3">
                                                <h5 class="mb-0">
                                                    <button class="btn btn-block   btn-outline-success  collapsed" type="button" data-toggle="collapse" data-target="#collapseB" aria-expanded="false" aria-controls="collapse3">
                                                        <strong style="font-size: 20px;"> <i class=" ti-check-box"></i> Agendar nueva cita </strong> <br>
                                                        <small class="form-control-feedback">Reserva desde aquí una nueva cita</small>
                                                    </button> <br>
                                                </h5>
                                            </div>
                                            <div id="collapseB" class="collapse" aria-labelledby="heading3" data-parent="#accordionExample2">
                                                <div class="card-body">
                                                    <!--  -->
                                                    <div class="row">
                                                        <div class="col-12">
                                        ...
                                        <div class="card m-b-0">
                                            <div class="card-header bg-white p-0" id="heading2">
                                                <h5 class="mb-0">
                                                    <button class="btn btn-block   btn-outline-success  collapsed" type="button" data-toggle="collapse" data-target="#collapseC" aria-expanded="false" aria-controls="collapse2">
                                                        <strong style="font-size: 20px;"> <i class="ti-pin-alt"></i> Citas en lista de espera </strong><br>
                                                        <small class="form-control-feedback">Ingrese a la lista de espera para agendamiento de una cita <br> especial en tu IPs </small>
                                                    </button> <br>

                                                </h5>
                                            </div>
                                            <div id="collapseC" class="collapse" aria-labelledby="heading2" data-parent="#accordionExample2">
                                                <div class="card-body">
                    ...
                    <div class="card m-b-0">
                        <div class="card-header bg-white p-0" id="heading3">
                            <h5 class="mb-0">
                                <button class="btn btn-block btn-lg btn-info collapsed" type="button" data-toggle="collapse" data-target="#collapse3" aria-expanded="false" aria-controls="collapse3" id="inicio">
                                     <i class="icon-grid"></i></i> Servicios
                                </button>
                            </h5>
                        </div>
                        <br>
                        <div id="collapse3" class="collapse" aria-labelledby="heading3" data-parent="#accordionExample1">
                            <div class="card-body">
                                <ul class="nav nav-tabs customtab" role="tablist">
                                    <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#lab" role="tab"><span class="hidden-sm-up">
                                                <center><i class="fas fa-vial"></i>
                                            </span></center> <br> <span class="hidden-xs-down">Laboratorios</span></a> </li>
                                    <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#vac" role="tab"><span class="hidden-sm-up">
                                                <center><i class="fas fa-pills"></i>
                                            </span></center> <br> <span class="hidden-xs-down">Medicamentos</span></a> </li>
                                    <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#imag" role="tab"><span class="hidden-sm-up">
                                                <center><i class="fas fa-x-ray"></i>
                                            </span></center> <br><span class="hidden-xs-down">Imagenes D</span></a> </li>
                                </ul>
                                <!-- Tab panes -->
                    ...
                    <div class="card m-b-0">
                        <div class="card-header bg-white p-0" id="heading1">
                            <h5 class="mb-0">
                                <button class="btn btn-block btn-lg btn-info" type="button" data-toggle="collapse" data-target="#collapse4" aria-expanded="true" aria-controls="collapse4" id="inicio">
                                    <i class="icon-user-following"></i> Perfil
                                </button>
                            </h5>
                        </div>
                        <br>
                        <div id="collapse4" class="collapse" aria-labelledby="heading1" data-parent="#accordionExample1">
                            <div class="card-body">
                                <div class="col-12">
                                    <div class="card">
                                        <center>
                                            <div class="user-bg"> <img width="30%" alt="user" src="../../assets/images/users/1.jpg" class="img-circle img-responsive "> </div>
                                        </center>
                                        <div class="card-body">
                                            <div class="user-btm-box">
                                                ...
                                                <div class="row text-center m-t-10">
                                                    <div class="col-6 b-r"><strong>Nombres</strong>
                                                        <p>Jonathan Doe</p>
                                                    </div>

                                                    <div class="col-6"><strong>Apellidos</strong>
                                                        <p>Engineer</p>
                                                    </div>
                                                </div>
                                                <hr>
                                                <div class="row text-center m-t-10">
                                                    <div class="col-6 b-r"><strong> Identificacion/Numero</strong>
                                                        <p>CC / 13862306 </p>
                                                    </div>
                                                    <div class="col-6"><strong>F nacimiento / Edad</strong>
                                                        <p>04-05-1987 / 37</p>
                                                    </div>
                                                </div>
                                                <hr>
                                                <div class="row text-center m-t-10">
                                                    <div class="col-6 b-r"><strong>Correo electronico</strong>
                                                        <p>Jonathan@hot.com</p>
                                                    </div>
                                                    <div class="col-6"><strong>Celular</strong>
                                                        <p>3142213405</p>
                                                    </div>
                                                </div>
                                                <!-- /.row -->
                                                ...
                                                <!-- .row -->
                                                <div class="row text-center m-t-10">
                                                    <div class="col-6 b-r"><strong>Ips de preferencia</strong>
                                                        <p>Cajasan IPs</p>
                                                    </div>
                                                    <div class="col-6"><strong>Ciudad de Residencia</strong>
                                                        <p>Barrancabermeja</p>
                                                    </div>
                                                </div>
                                                <!-- /.row -->
